...
class StreamlitApp:
    ...
    def app_layout(self):
        ...
        with st.sidebar:
            ...
            st.markdown('[![GitHub](https://img.shields.io/badge/GitHub-black.svg)](https://github.com/puffdapaz/pythonIPEA)')
            st.markdown('[![Article](https://img.shields.io/badge/Article-red.svg)](https://github.com/puffdapaz/pythonIPEA/blob/main/Impacto%20da%20receita%20tributária%20no%20desenvolvimento%20econômico%20e%20social.%20um%20estudo%20nos%20municípios%20brasileiros.pdf)')
            st.markdown('[![linkedIn](https://img.shields.io/badge/linkedIn-blue.svg)](https://www.linkedin.com/in/silvaph)')
